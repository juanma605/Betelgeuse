@echo off
rem Corre el scrape. Lo usa la tarea programada de las 7 (sin ventana) y lo
rem llama scrape_ahora.bat cuando lo corrés a mano. El progreso sale en
rem pantalla y queda en data\cron.log a la vez (lo hace Python, ver
rem logging.file en config).
...
"C:\Users\juanm\AppData\Local\Microsoft\WindowsApps\PythonSoftwareFoundation.Python.3.11_qbz5n2kfra8p0\python.exe" -m inmobot scrape
